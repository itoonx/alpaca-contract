...
describe('Vault - Pancake', () => {
  ...
  it('should work', async () => {
    ...
    expect(await pancakeswapWorker.health(1)).to.be.bignumber.eq(ethers.utils.parseEther('1.997459271062521105'));
  ...
  it('should reinvest correctly', async () => {
    ...
    // eve should earn cake as a reward for reinvest
    AssertHelpers.assertAlmostEqual(
      ethers.utils.parseEther('0.060799999999799266').toString(),
      (await cake.balanceOf(await eve.getAddress())).toString(),
    );
